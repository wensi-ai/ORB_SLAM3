    ...
    mnInitialFrameId(0), mbCreatedMap(false), mnFirstFrameId(0), mpCamera2(nullptr), mpLastKeyFrame(static_cast<KeyFrame*>(NULL))
{
    ...
    // get sensor type
    mbVI = mSensor == System::IMU_MONOCULAR || mSensor == System::IMU_STEREO || mSensor == System::IMU_RGBD;
}
    ...
    else
    {
        ...
        else
        {
            ...
            if(mState == LOST)
            {
                ...
                if(mbVI && pCurrentMap->isImuInitialized()){
                    bOK = PredictStateIMU();
                } else {
                    bOK = false;
                }
...
void Tracking::MonocularInitialization()
{
    ...
    else
    {
        ...
        if (((int)mCurrentFrame.mvKeys.size()<=100)||mLastFrame.mTimeStamp-mInitialFrame.mTimeStamp>0.3)
        {
...
bool Tracking::TrackWithMotionModel()
{
    ...
    if (mbVI && mpAtlas->isImuInitialized() && (mCurrentFrame.mnId>mnLastRelocFrameId+mnFramesToResetIMU))
    {
